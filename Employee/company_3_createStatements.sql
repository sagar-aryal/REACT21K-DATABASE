...
insert into workerOfDepartment values(1,2);
insert into workerOfDepartment values(2,3);
insert into workerOfDepartment values(3,4);
insert into workerOfDepartment values(2,5);
insert into workerOfDepartment values(3,6);
...
grant all privileges on companydb3.* to 'bigboss'@'localhost';
